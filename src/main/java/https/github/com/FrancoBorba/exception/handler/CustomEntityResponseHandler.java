...
public class CustomEntityResponseHandler extends ResponseEntityExceptionHandler{
  ...
  public final ResponseEntity<ExceptionResponse> handleNotFoundExceptions (Exception ex , WebRequest request){
   ...
   @ExceptionHandler(RequiredObjectIsNullExcpetion.class)
  public final ResponseEntity<ExceptionResponse> handleBadRequesteExcpetion (Exception ex , WebRequest request){
    ExceptionResponse response = new ExceptionResponse(new Date(),
     ex.getMessage(), 
     request.getDescription(false));
  ...
  @ExceptionHandler(FileNotFoundExcpetion.class)
