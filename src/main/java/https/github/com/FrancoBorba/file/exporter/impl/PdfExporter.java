...
import https.github.com.FrancoBorba.file.exporter.contract.PersonExporter;
import https.github.com.FrancoBorba.services.QRCodeService;
...
public class PdfExporter implements PersonExporter {
   ...
   @Autowired
    ...
    public Resource exportPerson(PersonDTO person) throws Exception {
        ...
        InputStream qrCodeStream = service.gerateQRCode(person.getUrlProfile(), 200, 200);
